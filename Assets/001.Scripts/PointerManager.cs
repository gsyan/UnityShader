...
public class PointerManager : MonoBehaviour, IGvrGazePointer
{
    ...
    private const float kReticleMinOuterAngle = 1.5f;//0.5
    // Angle at which to expand the reticle when intersecting with an object
    // (in degrees).
    private const float kReticleGrowthAngle = 3.5f;//1.5
                           ...
                           bool isInteractive)
    {
        ...
        //_staySeconds += Time.deltaTime;
        //if( _staySeconds > ExcuteSeconds)
        //{
    ...
    private void UpdateDiameters()
    {
        ...
        //Debug.Log(inner_diameter);
        //Debug.Log(outer_diameter);
